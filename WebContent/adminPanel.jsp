...
<body>
	...
	<aside id="sidebar" class="column">
		...
		<h3>Student</h3>
		<ul class="toggle">
			<li class="icn_add_user"><a href="#addNewStudent" rel="ajax">Add New Student</a></li>
			<li class="icn_edit_article"><a href="#viewAllStudent" rel="ajax">View All Student</a></li>
			<li class="icn_hostel1"><a href="#allotHostel" rel="ajax">Hostel Allotment to Student</a></li>
			<li class="icn_hostelfee"><a href="#hostelFeeDiposit" rel="ajax">Hostel Fee Diposit</a></li>

		</ul>
		<h3>Administrator</h3>
		<ul class="toggle">
			<li class="icn_add_user"><a href="#createAdministrator">Add Admin User</a></li>
			<li class="icn_hostel"><a href="#addHostel">Add Hostel</a></li>
			<li class="icn_edithostel"><a href="#viewHostel">View Hostel</a></li>
		</ul>
		<h3>Setting</h3>
		<ul class="toggle">
			...
			<li class="icn_settings"><a href="#settingAdmin">Settings</a></li>
